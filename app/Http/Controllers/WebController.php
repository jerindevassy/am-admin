...
class WebController extends Controller
{
   public function index()
    ...
    if (Auth::check()) {
        ...
        return view('web.index',compact('categories','subcat','products','wishlist'));
    }
    public function productlist($id){
        ...
        return view('web.productlist',compact('categories','subcat','products','metal','occasians','wishlist'));
    }
    public function productdetails($id){
        ...
        return view('web.productdetails',compact('categories','products','properties','wishlist'));
    }
