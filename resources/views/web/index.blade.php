            ...
            <img src="{{asset('web/css/bgimage1.jpg')}}" alt="Image Description">
              <div class="overlay">
                       <div class="content">
                        ...
                        <button class="cta-button">SHOP BESTSELLERS</button>
                      </div>
              </div>
          </div>
...
.image-container-home {
  position: relative;
  width: 100%;
  height: 810px; /* Fixed height for the container */
  margin-bottom:10px;
}

/* The image takes up the full width and less than half of the height */
.image-container-home img {
  width: 100%;
  height: 100%; /* Make the image fill the container height */
  object-position: left center; /* Position image to the left */
...
.image-container-home .cta-button {
  padding: 10px 20px;
  font-size: 16px;
